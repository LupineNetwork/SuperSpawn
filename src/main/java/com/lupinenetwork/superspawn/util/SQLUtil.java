...
import com.lupinenetwork.superspawn.Constants;
    ...
    public static Driver getDriver(String driverName, Logger logger) {
        ...
        try {
            ...
            try {
                ...
                throw new RuntimeException("Failed to initialize the default driver, bailing out!", ex1);
            }
        }
        // We coulden't initialize the default driver
